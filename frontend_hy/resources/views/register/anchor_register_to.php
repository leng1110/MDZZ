...
<html>
    <head>
        ...
        <script type="text/javascript" src="http://i.huya.com/main/statics/js/WdatePicker.js"></script>
            ...
            <div class="scroll-content">
                <div class="nav-section" style="padding-bottom:0">
                    ...
                    <ul class="icon-filter">
                        ...
                        <li>
                            <a menu="ZhiFu" href="http://i.huya.com/index.php?m=Zhifu">
                    ...
                    <div class="to-upload">
                        <p>想获取更多的关注？</p>
                        <a href="http://ahuya.duowan.com/?r=videomanage/upload" target="_blank" class="btn btn-to-upload clickstat" eid="click/grzx/uploadvideo" eid_desc="点击/个人中心/上传视频">上传视频</a>
                    </div>
            </div>
                            ...
                            <div class="data-form">
                                <div class="upload-file">
                                    <div class="flash-upload-img">
                                        <input type="file" class="file" name="avatar" id="avatar_upload_file"  multiple="true">
