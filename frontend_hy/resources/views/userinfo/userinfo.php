...
<html>
    <head>
        ...
        <title>个人中心</title>
        <link rel="stylesheet" href="//assets.msstatic.com/project/yytv/center/2.9.2/css/admin.css">
        <style type="text/css">
        .main-col{*padding-bottom: 140px;}
        .main-col,.anchor-col,.anchor-content{min-height: 1400px;}
        </style>
...
<link href="//a.msstatic.com/huya/icenter/main/css/new_home_index__afee134.css" rel="stylesheet"/>
<!-- 图片裁剪样式 -->
...
/*我的佣金*/
.nav-scroll-wrap .nav-section .icon-zhifu{
    background-image: url('../main/statics/img/icon-zhifu.png');
}
.to-upload { width: 145px; margin: 20px auto 0; }
.to-upload p { font-family: 'Microsoft Yahei'; color: #999; }
.to-upload .btn-to-upload { padding: 10px 42px; background: #4AB8F0; border-radius: 3px; font-size: 14px; margin-top: 10px; }
</style>
<script>
...
<script type="text/javascript" src="//a.msstatic.com/huya/icenter/main/js/main_menu_0316d51.js"></script>
        ...
        <div class="nav-scroll-wrap">
            <div class="scroll-content">
                <div class="nav-section" style="padding-bottom:0">
                    ...
                    <ul class="icon-filter">
                        ...
                        <li>
                            <a menu="ZhiFu" href="#">
                                <span class="icon icon-zhifu"></span>
                                <span class="title">
                                    我的佣金
                                </span>
                            </a>
                    ...
                    <div class="to-be-anchor">
                        <p>想成为万人敬仰的主播？</p>
                        <a href="#" target="_blank" class="btn btn-to-anchor">成为主播</a>
                    </div>
            
                    <div class="to-upload">
                        <p>想获取更多的关注？</p>
                        <a href="#" target="_blank" class="btn btn-to-upload clickstat" eid="click/grzx/uploadvideo" eid_desc="点击/个人中心/上传视频">上传视频</a>
                    </div>
            </div>
            ...
            <div class="scroll-content">
                <div class="mod mod-user-center">
                    <img style="width:120px;height:120px;cursor:default;" class="user_icon" src="http://huyaimg.msstatic.com/avatar/1058/5b/91bce49bfbe23e37e423ddcd90883e_180_135.jpg" alt="头像">
                    ...
                    <img class="img_hover" src="http://a.msstatic.com/huya/icenter/2.4/img/header_hover.png" alt="上传图像">
                        ...
                        <input type="hidden" name="uid" value="2189134948">
                    ...
                    <div class="user_info">
                        <h2 style="font-size: 25px;" class="uesr_n">newqq_wffdoy02a</h2>
                                                    <span class="user_sex user_sex-female"></span>
                                                
                        <!-- <p class="yy_num"><span>YY:</span><span id="YY">2189195078</span></p> -->
                                                <!-- 第三方登陆，昵称同步 -->
                            <a href="javascript:void(0);" class="third_nick_sync" title="刷新页面同步昵称"></a>
                            <a href="#" class="third_change_n">修改昵称</a>
                                                <p class="user_msg">
                            <span class="user_age">
                                18岁</span>
                            <span class="user_add">
                            ...
                            <span>
                                <a href="userinfo_to" class="edit-information clickstat"  eid="click/grzx/myinfo/edit" eid_desc="点击/个人中心/我的信息/编辑">编辑资料</a>
                            </span>
                        </p>
            ...
            <div class="mod mod-basic" id="account_num">
                ...
                <div class="account_num_list">
                    ...
                    <div class="msg">
                        ...
                        <p class="msg_2">建议定期修改密码，保证账号安全</p>
		                                ...
		                                <a class="result" href="javascript:void(0);" id="thirdLoginPassword" data-loginType="qq" data-loginType="qq" data-userinfo="2189134948"></a>
                        <!-- 第三方登陆修改密码iframe -->
                ...
                <div class="account_num_list">
                    ...
                    <div class="msg">
                        <p class="msg_1">上传视频</p>
                        <p class="msg_2">想获取更多关注，快上传视频吧！</p>
                    </div>
                    <a class="result clickstat" href="http://ahuya.duowan.com/?r=videomanage/upload" target="_blank" eid="click/grzx/myinfo/uploadvideo" eid_desc="点击/个人中心/我的信息/上传视频"></a>
                </div>
            </div>
        </div>
